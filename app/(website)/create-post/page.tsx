...
export default function ResponsivePostEditorClone() {
  ...
  const hasImage = /<img\s/i.test(body) || images.length > 0;
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      formData.append("title", plainText.slice(0, 80) || "Untitled");
      ...
      setBody("");
      revokeMediaItems(images);
      revokeMediaItems(audios);
      revokeMediaItems(attachments);
      setImages([]);
      setAudios([]);
      setAttachments([]);
      setLink("");
        ...
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-[1.8fr_0.95fr] xl:gap-8">
          ...
          <aside className="h-fit rounded-[10px]  p-4  sm:p-5 lg:p-6">
            ...
            <div className="mt-5 space-y-4">
              ...
              >
                <div>
                  <div className="text-base font-medium text-[#121212] dark:text-white">Free access</div>
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="text-base font-medium dark:text-white">Paid access</div>
                    <p className="mt-1 text-sm leading-6 dark:text-white/50">
